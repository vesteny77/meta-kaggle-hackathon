...
def get_code_file_path(kernel_id: int, code_dir: Path = Path("data/raw_code")) -> Path:
    ...
    """
    # Convert to string and pad with leading zeros to ensure at least 7 digits
    id_str = str(kernel_id).zfill(7)
